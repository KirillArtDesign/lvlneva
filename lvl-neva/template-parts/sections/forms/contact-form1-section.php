...
<section class="section section-form section-full-screen clip-content background-brand" id="i5rmyn4f7_0">
	<div class="div flex-direction-horizontal size-height-full aic" id="igwrku9ze_0">
		<div class="div div--u-iqp65bist padding-global section-form_padding" id="iqp65bist_0">
			<div class="div grid-2 grid-2--3-col-tablet" id="i27s3qiyq_0">
				<h2 class="text heading-style-h4 text-color-white text-color-grey-mobile" data-original-text="ОБРАТНАЯ СВЯЗЬ" gsap-text-scroll-animation="" id="if61iqhaf_0">
					<div class="line-wrapper" style="height: 28px">
						<div class="line-mask" style="height: 28px">
							<div class="text-line">свяжитесь с нами</div>
						</div>
					</div>
				</h2>

				<div class="form text-color-white form_component form--u-ik9et6wvg" id="ik9et6wvg_0" data-lvl-neva-contact-form-wrap>
					<form action="#" class="form__state-default" id="ic1m4yor8_0" data-lvl-neva-contact-form novalidate>
						<div class="div flex-direction-vertical form_gap-medium grid_col-padding-left" id="i1pcovvn9_0">
							<div class="text heading-style-h2 heading-style-h2--form">
								Остались вопросы?
								Свяжитесь с нами
							</div>
							...
							<div class="div form_grid" id="ic4wjkfg8_0">
								<div class="form__field form_input-group form__field--u-iy5tp14h0 flex-direction-vertical color-inherit" data-field-position="" data-type-field="text" data-lvl-neva-contact-field="name" id="iy5tp14h0_0">
									<div class="text-subtitle text-style-caption form_input-label text-color-white-opacity" id="ixmpspttd_0">
										<span class="text-block-wrap-div">Имя</span>
									</div>
									<input class="form__input form_input text-style-body form__input--u-ipkws6fq5" id="ipkws6fq5_0" name="name" placeholder="Ваше имя" type="text" autocomplete="name" required>
								...
								<div class="form__field form_input-group form__field--u-ib0ot1oie flex-direction-vertical color-inherit" data-field-position="1" data-type-field="email" data-lvl-neva-contact-field="email" id="ib0ot1oie_0">
									<div class="text-subtitle text-style-caption form_input-label text-color-white-opacity" id="ixz4844i5_0">
										<span class="text-block-wrap-div">Почта</span>
									</div>
									<input class="form__input form_input text-style-body form__input--u-ivr1ezazi" id="ivr1ezazi_0" name="email" placeholder="Почта" type="email" autocomplete="email">
								...
								<div class="form__field form_input-group form__field--u-i3ihs10aj flex-direction-vertical color-inherit" data-field-position="2" data-type-field="tel" data-lvl-neva-contact-field="phone" id="i3ihs10aj_0">
									<div class="text-subtitle text-style-caption form_input-label text-color-white-opacity" id="i0yn2wmc8_0">
										<span class="text-block-wrap-div">Телефон</span>
									</div>
									<input class="form__input form_input text-style-body form__input--u-ipv0zcc0p" id="ipv0zcc0p_0" name="phone" placeholder="Телефон" type="tel" inputmode="tel" autocomplete="tel" required>
								...
								<div class="form__field form__field--u-i2qmwu17w flex-direction-vertical form_input-group color-inherit" data-field-position="3" data-type-field="textarea" data-lvl-neva-contact-field="comment" id="i2qmwu17w_0">
									<div class="text-subtitle text-style-caption form_input-label text-color-white-opacity" id="ib2uej5q1_0">
										<span class="text-block-wrap-div">Комментарий</span>
									</div>
									<textarea class="form__textarea text-style-body form_input form_input--is-message form__textarea--u-ix10ecljn" id="ix10ecljn_0" name="comment" placeholder="Сообщение"></textarea>
								...
								<div class="div form_checkbox-gap flex-direction-horizontal flex-align-center" id="igz4ohqcu_0">
									...
									<div class="text text-style-body text--u-i9w8yrx5e text-color-grey" id="i9w8yrx5e_0">
										<span class="text-block-wrap-div">
											...
											<span style="color: rgb(255, 255, 255)"><a href="<?php echo esc_url( $privacy_policy_url ); ?>" rel="noreferrer" target="_blank">персональных данных</a></span>
										</span>
									</div>
							...
							<div class="card-wrapper border-radius" data-original-height="126.65625" style="height: 126.656px">
								<div class="card-mask border-radius" style="height: 127px">
									<div class="form__submit-wrap">
										<button class="button-large_component hero-corner-roll-btn hero-corner-roll-btn--white-brand-hover hero-corner-roll-btn--h100" data-action-element="" data-lvl-neva-contact-submit gsap-elements-scroll-animation="" id="i8o80ox3i_0" type="submit">
											<span class="hero-corner-roll-btn__label" data-label="Отправить заявку">
												<span class="hero-corner-roll-btn__label-text">Отправить заявку</span>
											</span>
