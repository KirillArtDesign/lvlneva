...
?>
<section class="section section-form section-full-screen clip-content background-brand">
	<div class="div flex-direction-horizontal size-height-full aic" id="igwrku9ze_0">
		<div class="div div--u-iqp65bist padding-global section-form_padding" id="iqp65bist_0">
			<div class="div grid-2 grid-2--3-col-tablet">
				<h2 class="text heading-style-h4 text-color-white text-color-grey-mobile" data-original-text="ОБРАТНАЯ СВЯЗЬ" gsap-text-scroll-animation="">
				...
				<div class="form text-color-white form_component form--u-ik9et6wvg" data-lvl-neva-contact-form-wrap>
						...
						<div class="div flex-direction-vertical form_gap-medium grid_col-padding-left">
							...
							<div class="div form_grid">
								<div class="form__field form_input-group form__field--u-iy5tp14h0 flex-direction-vertical color-inherit" data-field-position="" data-type-field="text" data-lvl-neva-contact-field="name">
									...
									<input class="form__input form_input text-style-body form__input--u-ipkws6fq5" name="name" placeholder="Ваше имя" type="text" autocomplete="name" required>
								...
								<div class="form__field form_input-group form__field--u-ib0ot1oie flex-direction-vertical color-inherit" data-field-position="1" data-type-field="email" data-lvl-neva-contact-field="email">
									...
									<input class="form__input form_input text-style-body form__input--u-ivr1ezazi" name="email" placeholder="Почта" type="email" autocomplete="email">
								...
								<div class="form__field form_input-group form__field--u-i3ihs10aj flex-direction-vertical color-inherit" data-field-position="2" data-type-field="tel" data-lvl-neva-contact-field="phone">
									...
									<input class="form__input form_input text-style-body form__input--u-ipv0zcc0p" name="phone" placeholder="Телефон" type="tel" inputmode="tel" autocomplete="tel" required>
								...
								<div class="form__field form__field--u-i2qmwu17w flex-direction-vertical form_input-group color-inherit" data-field-position="3" data-type-field="textarea" data-lvl-neva-contact-field="comment">
									...
									<textarea class="form__textarea text-style-body form_input form_input--is-message form__textarea--u-ix10ecljn" name="comment" placeholder="Сообщение"></textarea>
							...
							<div class="card-wrapper border-radius" data-original-height="126.65625" style="height: 126.656px">
								<div class="card-mask border-radius" style="height: 127px">
									<div class="form__submit-wrap">
										<button class="button-large_component hero-corner-roll-btn hero-corner-roll-btn--white-brand-hover hero-corner-roll-btn--h100" data-action-element="" data-lvl-neva-contact-submit gsap-elements-scroll-animation="" type="submit">
