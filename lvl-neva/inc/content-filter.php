...
if ( ! function_exists( 'lvl_neva_get_content_filter_query' ) ) {
	function lvl_neva_get_content_filter_query( $config, $term_id = 0 ) {
		$query_args = array(
...
if ( ! function_exists( 'lvl_neva_get_content_filter_results_html' ) ) {
	function lvl_neva_get_content_filter_results_html( $config, $term_id = 0 ) {
		$filter_query = lvl_neva_get_content_filter_query( $config, $term_id );

		ob_start();
		?>
		<div class="div collection" data-content-filter-results>
			<div role="list" class="div collection__list <?php echo esc_attr( $config['collection_classes'] ); ?>">
...
if ( ! function_exists( 'lvl_neva_handle_content_filter_ajax' ) ) {
	function lvl_neva_handle_content_filter_ajax() {
		...
		wp_send_json_success(
			array(
				'html' => lvl_neva_get_content_filter_results_html( $config, $term_id ),
			)
		);
	}
}
