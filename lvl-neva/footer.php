...
?>
			...
			<footer class="div footer_component background-white">
				<div class="div padding-global footer_padding-medium">
					<div class="div grid-4 grid-4--is-footer">
						...
						<div class="div grid-4_col grid_col-padding-horizontal div--u-ia4lyfuvx">
							<div class="div flex-direction-vertical footer_gap-medium">
								<h5 class="text heading-style-h6 text-color-grey"><span class="text-block-wrap-div">меню</span></h5>
								<div class="div footer_gap-small flex-direction-horizontal flex-direction-horizontal--is-footer">
									<div class="div flex-direction-vertical footer_gap-small">
						...
						<div class="div grid-4_col grid_col-padding-horizontal div--u-i4u0z48q2">
							<div class="div flex-direction-vertical footer_gap-medium">
								<h5 class="text heading-style-h6 text-color-grey"><span class="text-block-wrap-div">Соцсети</span></h5>
								<div class="div flex-direction-vertical footer_gap-small">
						...
						<div class="div grid-4_col grid_col-padding-left div--u-i23i7nbea">
							<div class="div flex-direction-vertical footer_gap-medium">
								<h5 class="text heading-style-h6 text-color-grey"><span class="text-block-wrap-div">Для связи</span></h5>
								<div class="div flex-direction-vertical footer_gap-small">
									...
									<div class="text text-style-body text-color-grey"><span class="text-block-wrap-div">Адрес</span></div>
									<div class="div footer_gap-xsmall flex-direction-vertical">
				...
				<div class="div padding-global footer_padding-small border-top">
					<div class="div grid-4 grid-4--is-footer grid-4--is-credit">
						<div class="div grid-4_col">
							<div class="text text-style-body text-color-grey">
								<span class="text-block-wrap-div"><?php echo esc_html( $site_copyright ); ?></span>
							</div>
						</div>
						<div class="div grid-4_col grid_col-padding-horizontal show-on-desktop"></div>
						<div class="div grid-4_col grid_col-padding-horizontal div--u-idmpx1hh2">
